...
let valor1_parte6 = 10;
let valor2_parte6 = 3.14;
let resultado_parte6 = valor1_parte6 - valor2_parte6; // Subtração correta
console.log(`A diferença entre ${valor1_parte6} e ${valor2_parte6} é igual a ${resultado_parte6}.`);
...
// Verifique se é positivo, negativo ou zero. Use if-else para imprimir a respectiva mensagem.
...
let numeroInteiro1a10 = Math.floor(Math.random() * 10) + 1; // (0–9) + 1
console.log(`Número inteiro entre 1 e 10: ${numeroInteiro1a10}`);

// Use o Math.random para gerar um número inteiro entre 1 e 1000 e exiba esse número no console.
let numeroInteiro1a1000 = Math.floor(Math.random() * 1000) + 1; // (0–999) + 1
